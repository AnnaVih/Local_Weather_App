...
var _weatherData = __webpack_require__(329);
...
//Importing classes
var weatherData = function weatherData(position) {
    var lat = void 0,
        long = void 0,
        weatherDataByLocation = void 0;
    ...
    weatherDataByLocation = new _weatherData.GetWeatherByLocation(lat, long);

    //Getting data from Api server
    weatherDataByLocation.get().then(function (results) {
        console.log(results);
    }).catch(function (err) {
...
var GetWeatherByLocation = function () {
    function GetWeatherByLocation(latitudeOrCity, longtitudeOrState) {
        _classCallCheck(this, GetWeatherByLocation);
    ...
    _createClass(GetWeatherByLocation, [{
        key: "get",
        value: function () {
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return fetch("https://api.openweathermap.org/data/2.5/weather?lat=" + this.latitudeOrCity + "&lon=" + this.longtitudeOrState + "&appid=" + this.apiKey);
...
var GetWeatherByCity = function () {
    function GetWeatherByCity(city) {
        _classCallCheck(this, GetWeatherByCity);
                ...
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.next = 2;
                                return fetch("https://api.openweathermap.org/data/2.5/weather?q=" + this.city + "&appid=" + this.apiKey);
